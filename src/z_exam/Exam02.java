...
/*		[ 연습문제 ]
				...
				d. float
				e. double
				[2-9] 다음 중 형변환을 생략할 수 있는 것은? (모두 고르시오) b,d,e
				byte b = 10;
				char ch = 'A';
				int i = 100;
				long l = 1000L;
				...
				b. ch = (char)b;
				c. short s = (short)ch;
				d. float f = (float)l; <-float은 4byte 고 long은 8byte 지만 float이 표현범위가 더 넣다
				e. i = (int)ch;
				...
				[2-13] 다음 중 타입과 기본값이 잘못 연결된 것은? (모두 고르시오) c,e
				a. boolean - false
				b. char - '\u0000'
				c. float - 0.0
				d. int - 0
